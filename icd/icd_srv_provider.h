 ...
 */
typedef void
(*icd_srv_provider_connect_cb_fn)     (enum icd_srv_status status,
                                       const gchar *err_str,
                                       gpointer user_data);
 ...
 */
typedef void
(*icd_srv_provider_disconnect_cb_fn) (enum icd_srv_status status,
                                       gpointer user_data);
...
gboolean
icd_srv_provider_connect        (struct icd_iap *iap,
...
gboolean
icd_srv_provider_notify_pid     (struct icd_context *icd_ctx,
                                 const pid_t pid,
